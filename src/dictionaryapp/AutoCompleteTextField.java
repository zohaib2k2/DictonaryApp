...
public class AutoCompleteTextField extends JTextField implements KeyListener,
    ...
    private DoubleLinkList<String> history = new DoubleLinkList<>();
    private DoubleLLNode currentWordHistory = history.getTail();
    ...
    /**
     * appends string word in the link list 'history'
     * @param word 
     */
    public void addHistoryWord(String word){
        history.append(word);
        currentWordHistory = history.getTail();
    }
    
    /**
     * removes a word from a linked list of history
     * @param word 
     */
     ...
     */
    public void removeAllHistoy(){
        history = new DoubleLinkList<>();
        currentWordHistory = null;
    }
    ...
    public void keyPressed(KeyEvent e) { 
        ...
        if(e.getKeyCode() == KeyEvent.VK_UP && !this.areGuessing){
           if(this.currentWordHistory != null){
                this.setText((String)(this.currentWordHistory.getData()));
                this.currentWordHistory = this.currentWordHistory.getPrevLink();
           } else {
               this.currentWordHistory = this.history.getHead();
           }
           this.areGuessing = false;
           e.consume();
        }
        
        if(e.getKeyCode() == KeyEvent.VK_DOWN && !this.areGuessing ){
           if(this.currentWordHistory != null){
                this.setText((String)(this.currentWordHistory.getData()));
                this.currentWordHistory = this.currentWordHistory.getNextLink();
           } else {
               this.currentWordHistory = this.history.getTail();
           }
           this.areGuessing = false;
           e.consume();
        }
